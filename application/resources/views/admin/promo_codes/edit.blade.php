    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Edit Promo</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Edit Promo</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/promos/edit')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <div class="m-form__heading mb-0">
                                                <h3 class="m-form__heading-title mb-0">Promo Details</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row" {{ $errors->has('name') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="promo_code" value="{{@$promo_list->code}}" class="form-control m-input" placeholder="">
                                            {!! $errors->first('name', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row" {{ $errors->has('name') ? 'has-error' : ''}}>
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Percentage (%): <span class="text-danger">*</span></label>
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="number" name="percent" value="{{@$promo_list->percent}}" class="form-control m-input" placeholder="">
                                            {!! $errors->first('name', '<p class="help-block" style="color: red;">:message</p>') !!}
                                        </div>
                                    </div>
                                    <div class="form-group m-form__group row" {{@$errors->has('status') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <select name="status" id="status" class="plxSelect2 form-control" required>
                                                ...
                                                <option value="1" {{(@$promo_list->status == 1) ? 'selected' : ''}}>Active</option>
                                                <option value="2" {{(@$promo_list->status == 2) ? 'selected' : ''}}>InActive</option>
                                            </select>
                            ...
                            <div class="m-form__actions m-form__actions">
                                <div class="row">
                                    <div class="col-lg-9 ml-lg-auto">
                                        <input type="hidden" name="id" value="{{@$promo_list->id}}">
