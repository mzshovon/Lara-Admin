            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                ...
                <div class="m-form m-form--label-align-left- m-form--state-" id="m_form">
                    ...
                    <div
                        ...
                        <div class="col-xl-9 col-lg-9">
                            @php $images_by_category = \Illuminate\Support\Facades\DB::table('category_images')->where('cat_id',$category->id)->get(); @endphp
                            @forelse($images_by_category as $images)
                                <img src="{{url('/').'/'.@$images->image_path}}"
