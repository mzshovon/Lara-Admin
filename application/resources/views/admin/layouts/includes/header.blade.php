                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50" src="{{asset('/')}}media/images/avatar/1.jpg">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <div class="header-info">
                                <span>Hello, <strong>{{env('APP_NAME')}}</strong></span>
                            </div>
                            <img src="{{asset('/')}}media/images/icon-bg.png" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{route('admin.logout')}}" class="dropdown-item ai-icon" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
