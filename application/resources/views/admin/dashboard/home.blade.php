...
<div class="container-fluid">
    <div class="form-head d-flex mb-3 align-items-start">
        <div class="mr-auto d-none d-lg-block">
            ...
            <p class="mb-0">Welcome to Lara-Admin!</p>
        </div>
    ...
    <div class="row">
                ...
                <div class="card-body revenue-chart px-3">
                        <div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
                            <div class="d-flex align-items-end mr-4">
                                <img src="{{asset('/')}}media/images/svg/ic_stat2.svg" height="22" width="22" class="mr-2 mb-1" alt=""/>
                                <div>
                            ...
                            <div class="d-flex align-items-end">
                                <img src="{{asset('/')}}media/images/svg/ic_stat1.svg" height="22" width="22" class="mr-2 mb-1" alt=""/>
                                <div>
        ...
        <div class="col-xl-3 col-xxl-3 col-lg-4 col-md-12">
            <div class="card bg-secondary" style="background-image:url({{asset('/')}}media/images/bg-icon.png); background-repeat:no-repeat; background-position:top right;">
