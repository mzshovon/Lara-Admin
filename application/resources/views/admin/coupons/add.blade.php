    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Add Coupons</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Add Coupons</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <form class="m-portlet m-portlet--last m-portlet--head m-portlet--responsive-mobile"
                  method="POST" action="{{url('admin/coupons/add/')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('coupon_name') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="coupon_name" value="{{old('coupon_name')}}" class="form-control m-input" placeholder="" required>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('coupon_number') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="coupon_number" value="{{old('coupon_number')}}" class="form-control m-input" placeholder="" required>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('coupon_price') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="coupon_price" value="{{old('coupon_price')}}" class="form-control m-input" placeholder="" required>
                                    ...
                                    <div class="form-group m-form__group row" {{ $errors->has('expire_date') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="expire_date" value="{{old('expire_date')}}" class="form-control m-input plx_datepicker" placeholder="" required>
